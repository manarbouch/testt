...
let movies = [
  ...
  function displayFailureImage() {
    console.log("Displaying failure image..."); // Debugging
    let failureImage = document.getElementById('failureImage');
    
    if (!failureImage) {
      failureImage = document.createElement('img');
      failureImage.id = 'failureImage';
      failureImage.src = 'img/failure.png'; // Correct image path
      failureImage.alt = 'You Lost!';
      
      // Styling to center the image
      failureImage.style.display = 'block';
      failureImage.style.margin = '20px auto';
      failureImage.style.width = '300px'; // Adjust the image size as needed
      failureImage.style.position = 'fixed'; // Fixed positioning
      failureImage.style.top = '50%'; // Position from top
      failureImage.style.left = '50%'; // Position from left
      failureImage.style.transform = 'translate(-50%, -50%)'; // Center the image
      failureImage.style.zIndex = '9999'; // Make sure it appears above other content
      
      // Append the image to the body
      document.body.appendChild(failureImage);
    }
  }
